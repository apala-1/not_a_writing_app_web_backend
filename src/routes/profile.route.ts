...
router.get("/:userId/followers", profileController.getFollowers.bind(profileController));
router.get("/:userId/following", profileController.getFollowing.bind(profileController));
...
router.get("/me/posts/saved", profileController.getSavedPosts.bind(profileController));
router.get("/me/posts/liked", profileController.getLikedPosts.bind(profileController));
